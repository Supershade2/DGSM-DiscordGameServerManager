...
namespace DiscordGameServerManager
{
    class Game_Profile
    {
        ...
        static Game_Profile()
        {
            ...
            if (!File.Exists(Properties.Resources.ResourcesDir + "/" + GlobalServerConfig.gvars.id + "/" + game + "/" + config))
            {
                File.Create(Properties.Resources.ResourcesDir + "/" + GlobalServerConfig.gvars.id + "/" + game + "/" + config).Close();
                ...
                File.WriteAllText(Properties.Resources.ResourcesDir + "/" + game+ "/" + config, json);
            ...
            {
                string json = File.ReadAllText(Properties.Resources.ResourcesDir + "/" + game + "/" + config);
